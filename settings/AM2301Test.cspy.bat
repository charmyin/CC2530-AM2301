...
"C:\Program Files (x86)\IAR Systems\Embedded Workbench 5.4\common\bin\cspybat" "C:\Program Files (x86)\IAR Systems\Embedded Workbench 5.4\8051\bin\8051proc.dll" "C:\Program Files (x86)\IAR Systems\Embedded Workbench 5.4\8051\bin\8051sim.dll"  %1 --plugin "C:\Program Files (x86)\IAR Systems\Embedded Workbench 5.4\8051\bin\<libsupport_plugin>" --backend -B "--proc_core" "plain" "--proc_code_model" "banked" "--proc_nr_virtual_regs" "8" "--proc_pdata_bank_reg_addr" "0x93" "--proc_dptr_nr_of" "1" "--proc_codebank_reg" "0x9F" "--proc_codebank_start" "0x8000" "--proc_codebank_end" "0xFFFF" "--proc_codebank_mask" "0xFF" "--proc_data_model" "large" "-p" "C:\Program Files (x86)\IAR Systems\Embedded Workbench 5.4\8051\config\devices\_generic\io8052.ddf" "--proc_driver" "sim" 


@REM Loaded plugins:
@REM    C:\Program Files (x86)\IAR Systems\Embedded Workbench 5.4\8051\bin\8051libsupport.dll
